...
algebra::Vertex<int> algebra::operator+(const Vertex<int> &A, const Vertex<int> &B)
{
    std::vector<int> vertex;
...
algebra::Vertex<int> algebra::operator+(const Vertex<int> &A, const Vertex<double> &B)
{
    std::vector<int> vertex;
...
algebra::Vertex<int> algebra::operator+(const Vertex<int> &A, const Vertex<float> &B)
{
    std::vector<int> vertex;
