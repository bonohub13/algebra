...
algebra::Vertex<float> algebra::operator+(const Vertex<float> &A, const Vertex<int> &B)
{
    std::vector<float> vertex;
...
algebra::Vertex<float> algebra::operator+(const Vertex<float> &A, const Vertex<double> &B)
{
    std::vector<float> vertex;
...
algebra::Vertex<float> algebra::operator+(const Vertex<float> &A, const Vertex<float> &B)
{
    std::vector<float> vertex;
